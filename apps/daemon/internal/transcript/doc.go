...
// session / directive-batch correlation, and delegation to [executor.Executor] for the planner loop.
//
// Subpackages:
//   - [vocoding.net/vocode/v2/apps/daemon/internal/transcript/executor] — planner loop and dispatch
